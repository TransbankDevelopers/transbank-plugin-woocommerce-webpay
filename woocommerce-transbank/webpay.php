...
function woocommerce_transbank_init() {
    ...
    class WC_Gateway_Transbank extends WC_Payment_Gateway {
        ...
        public function registerPluginVersion()
        {
            ...
            (new PluginVersion)->registerVersion($commerceCode,
                $pluginVersion, wc()->version, PluginVersion::ECOMMERCE_WOOCOMMERCE);
        }
                  ...
                  <div class="tab-content">
                    <div id="info" class="tab-pane in active">
                      <fieldset class="tbk_info">
                        ...
                        <a class="button-primary" id="tbk_pdf_button"
                           href="<?php echo $this->plugin_url?>libwebpay/CreatePdf.php?document=report"
                           target="_blank">
                          Crear PDF
                        </a>
                      </fieldset>
                    ...
                    <div id="php_info" class="tab-pane">
                      <fieldset class="tbk_info">
                        ...
                        <a class="button-primary" href="<?php echo $this->plugin_url?>libwebpay/CreatePdf.php?document=php_info" target="_blank">
                          Crear PHP info
                        </a>
                        <br>
                      </fieldset>
        ...
        public function includeWordpressPluginFunctions()
        {
// Mandar ping a cumbre
            require_once(__DIR__ . '/libwebpay/Telemetry/PluginVersion.php');
